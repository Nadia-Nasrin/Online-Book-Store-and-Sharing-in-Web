 ...
 <div class="main_column column">
  <h3>Make Post</h3>
   <form class="post_form" action="index.php" method="POST" enctype="multipart/form-data">
     ...
     <br>
     <span>Price</span>
      <input type="post_text" name="price" id="post_button" size="50" class="form-control" placeholder="Price" value="0" required=""><br>
     <textarea class="form-control" name="post_text" id="post_text" placeholder="Description" required=""></textarea>
<br>
