...
//ALL CONTENT IN THIS FILE PROVIDED BY Create a REAL Social Network like Facebook in PHP + MySQL (https://www.udemy.com/make-a-social-media-website/) via Udemy_
//Content modified from: http://jcrop.org/
...
***********************************************************/
	...
	//Set Upload directory
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'Online Book Store/Obs/assets/images/profile_pics';
	//Set File Onlin
...
<div class="main_column column">
	...
	<div id="formExample">
	    ...
	    <form action="upload.php" method="post"  enctype="multipart/form-data">
	        <h4>Upload New Profile Picture</h4><br /><br />
	        <input type="file" id="image" name="image" style="width:200px; height:30px; " /><br /><br />
	        <input type="submit" class="success" value="Submit" style="width:85px; height:25px;" />
	    </form><br /><br />
